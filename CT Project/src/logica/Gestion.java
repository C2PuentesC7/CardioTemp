...
public class Gestion {
	...
	public Gestion(boolean b){
		...
		ejercicios.add(new Ejercicio (0, "Caminata", "Hagamosde cuenta que caminar es la acción de poner un pie frente al otro, de manera de que el Ser humano, animal o cosa que tenga pies o patas, pueda movilizarse de un determinado lugar a otro", 1, null));
		ejercicios.add(new Ejercicio (1, "Abdominales", "Dolor", 5, null));
		ejercicios.add(new Ejercicio (2, "Flexiones", "Ahhh un hombre lagarto...",4, null));
...
// Gestion Ejercicio
	...
	public String getHistorial() {
		return historiales.toString();
	}

	public Historial[] listarHistorial() {
		return historiales.toArray(new Historial[0]);
	}
