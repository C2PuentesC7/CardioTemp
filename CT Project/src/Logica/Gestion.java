...
public class Gestion {
	...
	private void valoresPorDefecto() {
		...
		ejercicios.add(new Ejercicio(0, "Caminata", "Hagamos de cuenta que caminar es la acci�n de poner un pie frente al otro, de manera de que el Ser humano, animal o cosa que tenga pies o patas, pueda movilizarse de un determinado lugar a otro", 1, new ImageIcon(getClass().getResource("/Imagenes/Ej0.jpg"))));
